...
namespace HighSellPrice
{
    public class HighSellPriceSettings : AttributeGlobalSettings<HighSellPriceSettings>
    {
        ...
        [SettingPropertyGroup("{=HSPOptG002}Food", GroupOrder = 0)]
        ...
        [SettingPropertyGroup("{=HSPOptG003}Craftables", GroupOrder = 1)]
        ...
        [SettingPropertyGroup("{=HSPOptG004}Others", GroupOrder = 2)]
